<div class="space-y-4 mb-6">
    <div class="flex gap-3">
        ...
        <p class="text-sm text-gray-700 dark:text-gray-300">Dial <span class="font-semibold">*322#</span>
            or open the <span class="font-semibold text-green-600 dark:text-green-400">Rocket</span> app.</p>
    </div>
    ...
    <div class="flex gap-3">
        ...
        <div class="flex-1">
            ...
            <div class="flex items-center gap-2">
                <code
                    class="flex-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded px-3 py-2 text-sm font-mono text-green-600 dark:text-green-400">01783110247</code>
                <button @click="copyToClipboard('01783110247')"
