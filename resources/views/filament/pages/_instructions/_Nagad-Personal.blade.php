<div class="space-y-4 mb-6">
    <div class="flex gap-3">
        ...
        <p class="text-sm text-gray-700 dark:text-gray-300">Dial <span class="font-semibold">*167#</span>
            or open the <span class="font-semibold text-green-600 dark:text-green-400">Nagad</span> app.</p>
    </div>
